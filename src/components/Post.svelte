...
<a href="feed/{post.id}" class="grid grid-rows-[9fr_1fr] p-2 border-t-2 hover:bg-base-300">
    <div class="grid grid-rows-[auto_1fr]">
        <div class="post-header flex items-center mb-2 bg-base-300 p-2 rounded-sm">
            <img
                class="avatar w-10 h-10 rounded-full mr-4"
                src={post.avatar}
                alt={post.username}
